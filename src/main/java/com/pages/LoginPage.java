...
public void clickEmail() throws InterruptedException {
	...
	List <WebElement>fli=driver.findElements(By.xpath("//*[@id=\"MainModule\"]/div/div/div[3]/div/div[3]/div[1]/div[1]/div[1]/div/div[3]/div/div[1]/i/span/i"));
for (WebElement ftt : fli) {
	...
	for (WebElement et : emailThreads) {
		...
		driver.findElement(By.xpath("//*[@id=\\\"ReadingPaneContainerId\\\"]/div/div/div/div[2]/div/div/div[1]/div/div/div/div/div[3]/div/div/div/div/table/tbody/tr/td/table/tbody/tr[3]/td/h3/a")).click();
